...
mod tests {
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_eight_by_eight_base_with_four_by_two_plate() {
        let base = Base::new(
            8,
            8,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_nine_by_eight_base_with_four_by_two_plate() {
        let base = Base::new(
            9,
            8,
            TestColor::default(),
        ...
        assert_valid_base::<9, 8>(
            &base, &[
                ...
                &[(3, 1), (3, 2), (4, 1), (4, 2), (3, 3), (3, 4), (4, 3), (4, 4)],
                &[(5, 1), (5, 2), (6, 1), (6, 2)],
                &[(7, 1), (7, 2), (8, 1), (8, 2), (7, 3), (7, 4), (8, 3), (8, 4)],
                &[(1, 3), (1, 4), (2, 3), (2, 4)],
                &[(5, 3), (5, 4), (6, 3), (6, 4)],
                &[(1, 5), (1, 6), (2, 5), (2, 6)],
                &[(3, 5), (3, 6), (4, 5), (4, 6)],
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_eight_by_nine_base_with_four_by_two_plate() {
        let base = Base::new(
            8,
            9,
            TestColor::default(),
        ...
        assert_valid_base::<8, 9>(
            &base, &[
                ...
                &[(5, 3), (5, 4), (6, 3), (6, 4)],
                &[(1, 5), (1, 6), (2, 5), (2, 6)],
                &[(3, 5), (3, 6), (4, 5), (4, 6), (3, 7), (3, 8), (4, 7), (4, 8)],
                &[(5, 5), (5, 6), (6, 5), (6, 6)],
                &[(1, 7), (1, 8), (2, 7), (2, 8)],
                &[(5, 7), (5, 8), (6, 7), (6, 8)]
            ],
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_nine_by_nine_base_with_four_by_two_plate() {
        let base = Base::new(
            9,
            9,
            TestColor::default(),
        ...
        assert_valid_base::<9, 9>(
            &base, &[
                ...
                &[(3, 5), (3, 6), (4, 5), (4, 6), (3, 7), (3, 8), (4, 7), (4, 8)],
                &[(5, 5), (5, 6), (6, 5), (6, 6)],
                &[(7, 5), (7, 6), (8, 5), (8, 6), (7, 7), (7, 8), (8, 7), (8, 8)],
                &[(1, 7), (1, 8), (2, 7), (2, 8)],
                &[(5, 7), (5, 8), (6, 7), (6, 8)]
            ],
            [
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_eight_by_eight_base_with_three_by_one_plate() {
        let base = Base::new(
            8,
            8,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_nine_by_eight_base_with_three_by_one_plate() {
        let base = Base::new(
            9,
            8,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_eight_by_nine_base_with_three_by_one_plate() {
        let base = Base::new(
            8,
            9,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_nine_by_nine_base_with_three_by_one_plate() {
        let base = Base::new(
            9,
            9,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_eight_by_eight_base_with_three_by_two_plate() {
        let base = Base::new(
            8,
            8,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_nine_by_eight_base_with_three_by_two_plate() {
        let base = Base::new(
            9,
            8,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_eight_by_nine_base_with_three_by_two_plate() {
        let base = Base::new(
            8,
            9,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_nine_by_nine_base_with_three_by_two_plate() {
        let base = Base::new(
            9,
            9,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_eight_by_eight_base_with_four_by_three_plate() {
        let base = Base::new(
            8,
            8,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_nine_by_eight_base_with_four_by_three_plate() {
        let base = Base::new(
            9,
            8,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_eight_by_nine_base_with_four_by_three_plate() {
        let base = Base::new(
            8,
            9,
            TestColor::default(),
    ...
    //noinspection DuplicatedCode
    #[test]
    fn test_nine_by_nine_base_with_four_by_three_plate() {
        let base = Base::new(
            9,
            9,
            TestColor::default(),
